...
inline namespace Configuration
{
	...
	{
	public:
		const char* BoxTypes[5] = { "Full Box","Cornered Box","style 3","style 4","style 5" };
		const char* AimbotLocations[5] = { "Head","Neck","Chest","Pelvis","Leg" };
		...
		const char* weaponcattypes[10] = { "Invalid","AssaultRifle","DMR","LightMachineGun","Shotgun","SniperRifle","SubMachineGun","Pistol","Melee","Gadget" };
		const char* ammotypes[10] = { "NINE_MM","SEVEN_63","FIVE_57","TWELVE_G","FORTY_FIVE","THREE_HUND","TWENTY_TWO","FIFTY","ABILITY","NONE" };
		const char* ammostates[5] = { "Full","NeedsReload","LowAmmo","CriticallyLowAmmo","NoAmmo" };
		const char* etesttypes[3] = { "etest","etest2","etest3" };
		int etest = 0;
		int AimbotLocation = 0;
		bool b_etest = false;
		float color_red = 0.5f;
		float color_green = 0.5f;
		...
		int EKSWeaponCatType = 4;
		bool eksweaponcattypebool = false;
		...
		ImColor crosshair = ImColor(255.0f / 128.f, 0.f, 128.f);
		float fl_crosshair[3] = { 255.0f / 128.f , 0.f ,128.f };
		...
		int FireType = 2;
		int ammotype = 0;
		bool b_ammotypes = false;
		bool b_ammostate = false;
		int ammostate = 0;
		int reloadtype = 0;
		int tab_index = 0;
		float boxwidth = 1.5f;
